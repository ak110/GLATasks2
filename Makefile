...
.PHONY: help sync backup deploy build start stop restart-app logs ps healthcheck shell node-shell update format test test-unit test-backup test-e2e start-app logs-app migrate db-studio
