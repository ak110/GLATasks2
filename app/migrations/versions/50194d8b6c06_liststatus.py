...
def upgrade():
    ...
    with op.batch_alter_table("list", schema=None) as batch_op:
        batch_op.add_column(sa.Column("status", sa.String(length=255), nullable=False, comment="ステータス"))
    ...
    with op.batch_alter_table("task", schema=None) as batch_op:
        ...
        batch_op.alter_column("text", existing_type=mysql.TEXT(), comment="内容", existing_nullable=False)
        batch_op.alter_column(
            "created",
